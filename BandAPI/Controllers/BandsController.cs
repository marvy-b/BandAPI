...
namespace BandAPI.Controllers 
{
    ...
    public class BandsController : ControllerBase
    {
        ...
        private readonly IPropertyValidationSeervice _propertyValidationSeervice; 

        public BandsController(IBandAlbumRepository bandAlbumRepository, IMapper mapper,
                                IPropertyMappingService propertyMappingService,
                                IPropertyValidationSeervice propertyValidationSeervice)
        {
            ...
            _propertyValidationSeervice = propertyValidationSeervice ??
                throw new ArgumentNullException(nameof(propertyValidationSeervice));
        }
        ...
        {
            if (!_propertyMappingService.ValidMappingExists<BandDto, Band>
                        (bandsResourceParameters.OrderBy))
              return BadRequest();

            if (!_propertyValidationSeervice.HasValidProperties<BandDto>
        ...
        {
            if (!_propertyValidationSeervice.HasValidProperties<BandDto>(fields))
                return BadRequest();
